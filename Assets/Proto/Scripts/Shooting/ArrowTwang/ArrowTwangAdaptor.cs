...
namespace SlickBowShooting{
	public interface IArrowTwangAdaptor: ISlickBowShootingMonoBehaviourAdaptor{
	...
	public class ArrowTwangAdaptor: SlickBowShootingMonoBehaviourAdaptor, IArrowTwangAdaptor{
