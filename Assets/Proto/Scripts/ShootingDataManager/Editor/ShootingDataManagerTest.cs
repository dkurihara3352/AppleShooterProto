...
// 		TestShootingDataManager manager = CreateTestShootingDataManager(out playerDataManager);
...
// 		IPlayerDataManager playerDataManager;
// 		TestShootingDataManager manager = CreateTestShootingDataManager(out playerDataManager);
// 		playerDataManager.GetTierSteps().Returns(tierSteps);
// 		playerDataManager.GetTierCount().Returns(tierCount);
...
// 		}
// 	}
// 	TestShootingDataManager CreateTestShootingDataManager(out IPlayerDataManager playerDataManager){
// 		TestShootingDataManager.IConstArg mockArg = Substitute.For<TestShootingDataManager.IConstArg>();
// 		IPlayerDataManager mockPlayerDataManager = Substitute.For<IPlayerDataManager>();
// 		playerDataManager = mockPlayerDataManager;
// 		playerDataManager.GetTierSteps().Returns(4);
// 		playerDataManager.GetTierCount().Returns(3);
// 		playerDataManager.GetTierLevelMultipliers().Returns(new int[3]{1, 2, 4});
// 		TestShootingDataManager result = new TestShootingDataManager(mockArg);
// 		result.SetPlayerDataManager(mockPlayerDataManager);
// 		return result;
// 	}
// }
