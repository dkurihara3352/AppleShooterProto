...
// 			uia.GetChildUIElements().Returns(new List<IUIElement>(new IUIElement[]{Substitute.For<IUIElement>()}));
...
// 				uia.GetChildUIElements()[0].GetUIAdaptor().Returns(childAdaptor);
// 		arg.uia.Returns(uia);
...
// 			uia.GetChildUIElements().Returns(returnedList);
