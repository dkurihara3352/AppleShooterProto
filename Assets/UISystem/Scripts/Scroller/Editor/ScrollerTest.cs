...
// 			TestScroller.IConstArg arg = CreateMockConstArg();
// 			IUIAdaptor uiAdaptor = (IUIAdaptor)arg.adaptor;
// 			uiAdaptor.GetRectSize().Returns(scrollerLength);
// 			arg.cursorLength.Returns(cursorLength);
// 			arg.relativeCursorPosition.Returns(relativeCursorPos);
// 			// Rect elementRect = new Rect(Vector2.zero, elementLength);
// 			IUIElement scrollerElement = arg.scrollerElement;
// 			scrollerElement.GetUIAdaptor().GetRectSize().Returns(elementLength);
// 			TestScroller scroller = new TestScroller(arg);
// 			// scroller.ActivateImple();
// 			scroller.SetUpCursorTransform();
// 			// scroller.SetUpScrollerElement();
...
// 			TestScroller.IConstArg arg = CreateMockConstArg();
// 			IUIElement parentUIE = Substitute.For<IUIElement>();
// 			((IUIAdaptor)arg.adaptor).GetParentUIElement().Returns(parentUIE);
// 			TestScroller scroller = new TestScroller(arg);
// 			scroller.SetUpCursorTransform();
// 			// scroller.SetUpScrollerElement();
// 			Assert.That(scroller.thisShouldProcessDrag_Test, Is.False);
...
// 		public TestScroller(TestScroller.IConstArg arg): base(arg){
...
// 		}
// 	}
// 	TestScroller.IConstArg CreateMockConstArg(){
// 		TestScroller.IConstArg arg = Substitute.For<TestScroller.IConstArg>();
...
// 			scrollerAdaptor.GetRectSize().Returns(new Vector2(100f, 100f));
// 			IUIElement child = Substitute.For<IUIElement>();
// 			IUIAdaptor childUIA = Substitute.For<IUIAdaptor>();
// 			child.GetUIAdaptor().Returns(childUIA);
// 			// List<IUIElement> returnedList = new List<IUIElement>(new IUIElement[]{child});
// 			IUIElement[] returnedArray = new IUIElement[]{child};
// 			scrollerAdaptor.GetChildUIElements().Returns(returnedArray);
// 		arg.adaptor.Returns(scrollerAdaptor);
