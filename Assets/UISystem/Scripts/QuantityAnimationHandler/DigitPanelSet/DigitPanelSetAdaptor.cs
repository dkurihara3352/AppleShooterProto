...
namespace UISystem{
	public interface IDigitPanelSetAdaptor: IResizableRectUIAdaptor/* , IInstatiableUIAdaptor */{
		IDigitPanelSet GetDigitPanelSet();
	}
	public class DigitPanelSetAdaptor: AbsResizableRectUIAdaptor<DigitPanelSet>, IDigitPanelSetAdaptor{
		...
		protected override IUIElement CreateUIElement(/* IUIImage image */){
			...
			DigitPanelSet.IConstArg arg = new DigitPanelSet.ConstArg(
				this,
				thisDigitPlace,
				thisPanelDim,
				thisPadding
			...
			return new DigitPanelSet(arg);
		}
		IDigitPanelSet thisDigitPanelSet{
			get{
				return (IDigitPanelSet)thisUIElement;
			}
		}
		public IDigitPanelSet GetDigitPanelSet(){
			return thisDigitPanelSet;
		}
		public override void SetUpReference(){
			base.SetUpReference();
			IDigitPanel[] digitPanels = CreateDigitPanels();
			thisDigitPanelSet.SetDigitPanels(digitPanels);
		}
		IDigitPanel[] CreateDigitPanels(){
			return null;
		}
	}
