...
namespace UISystem{
	public class GUIManager : MonoBehaviour {
		...
		IUIElement _thisRootUIElement;
		IUIElement thisRootUIElement{
			get{
				if(_thisRootUIElement == null)
					_thisRootUIElement = GetRootUIElement();
				return _thisRootUIElement;
			}
		}
		public UIAdaptor rootUIElementAdaptor;
		IUIElement GetRootUIElement(){
			return rootUIElementAdaptor.GetUIElement();
		}
		public UISystemMonoBehaviourAdaptorManager adaptorManager;
		IUIManager thisUIM{
			get{
		...
		void SetUpMonoBehaviourAdaptors(){
			...
			adaptorManager.SetUpAdaptorReference();
